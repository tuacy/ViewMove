...
public class OverScrollerDragActivity extends MobileBaseActivity {

	public static void startUp(Context context) {
		context.startActivity(new Intent(context, OverScrollerDragActivity.class));
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_over_scroller_drag);
		initView();
		initEvent();
		initData();
	}
