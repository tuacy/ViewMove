package com.tuacy.viewmove.module.overscroller.kernel;
...
public class OverScrollerKernel {
	 ...
	 */
	public OverScrollerKernel(Context context) {
		this(context, null);
	}
	 ...
	 */
	public OverScrollerKernel(Context context, Interpolator interpolator) {
	 ...
	 * @hide
	 */
	public OverScrollerKernel(Context context, Interpolator interpolator, boolean flywheel) {
	 ...
	 * @param context            The context of this application.
	 * @param interpolator       The scroll interpolator. If null, a default (viscous) interpolator will be used.
	 * @param bounceCoefficientX A value between 0 and 1 that will determine the proportion of the velocity which is preserved in the bounce
	 *                           when the horizontal edge is reached. A null value means no bounce. This behavior is no longer supported and
	 *                           this coefficient has no effect.
	 * @param bounceCoefficientY Same as bounceCoefficientX but for the vertical direction. This behavior is no longer supported and this
	 *                           coefficient has no effect.
	 * @deprecated Use {@link #OverScrollerKernel(Context, Interpolator)} instead.
	 */
	@Deprecated
	public OverScrollerKernel(Context context, Interpolator interpolator, float bounceCoefficientX, float bounceCoefficientY) {
		this(context, interpolator, true);
	}
	 ...
	 * @see #setFinalX(int)
	 * @see #setFinalY(int)
	 * @deprecated OverScrollers don't necessarily have a fixed duration. Instead of setting a new final position and extending the duration
	 * of an existing scroll, use startScroll to begin a new animation.
	 */
	@Deprecated
	 ...
	 * @see #setFinalY(int)
	 * @deprecated OverScroller's final position may change during an animation. Instead of setting a new final position and extending the
	 * duration of an existing scroll, use startScroll to begin a new animation.
	 */
	@Deprecated
	 ...
	 * @param minX      Minimum X value. The scroller will not scroll past this point unless overX > 0. If overfling is allowed, it will use
	 *                  minX as a springback boundary.
	 * @param maxX      Maximum X value. The scroller will not scroll past this point unless overX > 0. If overfling is allowed, it will use
	 *                  maxX as a springback boundary.
	 * @param minY      Minimum Y value. The scroller will not scroll past this point unless overY > 0. If overfling is allowed, it will use
	 *                  minY as a springback boundary.
	 * @param maxY      Maximum Y value. The scroller will not scroll past this point unless overY > 0. If overfling is allowed, it will use
	 *                  maxY as a springback boundary.
	 ...
	 * @param overX  Magnitude of overscroll allowed. This should be the maximum desired distance from finalX. Absolute value - must be
	 *               positive.
	 */
	 ...
	 * @param overY  Magnitude of overscroll allowed. This should be the maximum desired distance from finalY. Absolute value - must be
	 *               positive.
	 */
	...
	static class SplineOverScroller {
		...
		void fling(int start, int velocity, int min, int max, int over) {
			...
			mStartTime = AnimationUtils.currentAnimationTimeMillis();
			mCurrentPosition = mStart = start;
			Log.d("tuacy", "start = " + start + " min = " + min + " max = " + max + " velocity = " + velocity);
